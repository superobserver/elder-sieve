...
d = [91]*int(new_test) #91
e = [89]*int(new_test) #89
f = [83]*int(new_test) #83
g = [79]*int(new_test)
h = [77]*int(new_test)
i = [73]*int(new_test)
j = [71]*int(new_test)
...
for x in xrange(1, 10): # 10000 = 12; 100000 = 36; 1,000,000 = 108; 10,000,000 = 336; 100,000,000 = 1056; 1,000,000,000 = 
