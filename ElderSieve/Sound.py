...
d = [91]*int(new_test) #A224889 Numbers n such that 90n + 91 are prime
e = [89]*int(new_test) #A202116 Numbers n such that 90n + 89 is prime.
f = [83]*int(new_test) #A196007 Numbers n such that 90n + 83 is prime.
g = [79]*int(new_test) #A202112 Numbers n such that 90n + 79 is prime.
h = [77]*int(new_test) #A201822 Numbers k such that 90*k + 77 is prime.
i = [73]*int(new_test) #A195993 Numbers n such that 90n + 73 is prime.
j = [71]*int(new_test) #A202129 Numbers n such that 90n + 71 is prime.
k = [67]*int(new_test) #A201817 Numbers k such that 90*k + 67 is prime.
q = [61]*int(new_test) ##A202113 Numbers n such that 90n + 61 is prime.
p = [59]*int(new_test) #A202101 Numbers n such that 90*n + 59 is prime.
r = [53]*int(new_test) #A202114 Numbers n such that 90n + 53 is prime.
s = [49]*int(new_test) #A201818 Numbers k such that 90*k + 49 is prime.
t = [47]*int(new_test) #A201734 Numbers n such that 90*n + 47 is prime 
u = [43]*int(new_test) #A202105 Numbers n such that 90*n + 43 is prime.
v = [41]*int(new_test) #A202104 Numbers n such that 90*n + 41 is prime.
w = [37]*int(new_test) #A198382 Numbers n such that 90n + 37 is prime.
ww = [31]*int(new_test) #A201819 Numbers n such that 90*n + 31 is prime.
www = [29]*int(new_test) #A201739 Numbers n such that 90*n + 29 is prime.
wx = [23]*int(new_test) #A201820 Numbers k such that 90*k + 23 is prime.
xx = [19]*int(new_test) #A196000 Numbers n such that 90n + 19 is prime.
c = [17]*int(new_test) #A202115 Numbers n such that 90n + 17 is prime.
b = [13]*int(new_test) #A201816 Numbers k such that 90*k + 13 is prime.
a = [11]*int(new_test) #A201804 Numbers k such that 90*k + 11 are prime.
xy = [7]*int(new_test) #A202110 Numbers n such that 90*n + 7 is prime.
#^--- all the primes
...
def drLD(x, l, m, z, o, list_var, primitive_var):      
  y = 90*(x*x) - l*x + m 
  if y < new_test:
    list_var[y] = 0# primitive_var #0
  else:
    return
  for n in xrange (1, new_test):
    new_y = y+((z+(90*(x-1)))*n)
    if new_y < new_test:
      list_var[new_y] = 0# z #0
    new2_y = y+((o+(90*(x-1)))*n)   
    if new2_y < new_test:    
      list_var[new2_y] = 0#o #0     
    if new_y > new_test:
      return
    else:
      pass
...
for x in xrange(1, 17): # 10000 = 12; 100000 = 36; 1,000,000 = 108; 10,000,000 = 336; 100,000,000 = 1056; 1,000,000,000 = "Hey I need to checksum these tables, all hand-entered
...
instrument_var_telephone = 125 #telephone ringing



MyMIDI.addProgramChange(0, 0, 0, int(instrument_var_violin))
MyMIDI.addProgramChange(0, 1, 0, int(instrument_var_viola))
MyMIDI.addProgramChange(0, 2, 0, int(instrument_var_cello))
MyMIDI.addProgramChange(0, 3, 0, int(instrument_var_orchestralharp))
MyMIDI.addProgramChange(0, 4, 0, int(instrument_var_trumpet))
MyMIDI.addProgramChange(0, 5, 0, int(instrument_var_clavinet))
MyMIDI.addProgramChange(0, 6, 0, int(instrument_var_glockenspiel))
MyMIDI.addProgramChange(0, 7, 0, int(instrument_var_xylophone))
MyMIDI.addProgramChange(0, 8, 0, int(instrument_var_altosax))
MyMIDI.addProgramChange(0, 9, 0, int(instrument_var_piccolo))
MyMIDI.addProgramChange(0, 10, 0, int(instrument_var_englishhorn))
MyMIDI.addProgramChange(0, 11, 0, int(instrument_var_orchestralharp))
MyMIDI.addProgramChange(0, 12, 0, int(instrument_var_bassoon))
MyMIDI.addProgramChange(0, 13, 0, int(instrument_var_frenchhorn))
MyMIDI.addProgramChange(0, 14, 0, int(instrument_var_clarinet))
MyMIDI.addProgramChange(0, 15, 0, int(instrument_var_shamisen))
MyMIDI.addProgramChange(0, 16, 0, int(instrument_var_flute))
MyMIDI.addProgramChange(0, 17, 0, int(instrument_var_tuba))
MyMIDI.addProgramChange(0, 18, 0, int(instrument_var_timpani))
MyMIDI.addProgramChange(0, 19, 0, int(instrument_var_sopranosax))
MyMIDI.addProgramChange(0, 20, 0, int(instrument_var_steeldrums))
MyMIDI.addProgramChange(0, 21, 0, int(instrument_var_baritonesax))
MyMIDI.addProgramChange(0, 22, 0, int(instrument_var_dulcimer))
MyMIDI.addProgramChange(0, 23, 0, int(instrument_var_choralahh))
